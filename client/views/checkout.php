                    ...
                    <div class="mb-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input class="form-control" type="text" value="<?=$info['phone']?>" name="phone">
                            </div>
                            <div class="col-md-6 form-group">
                                <label>Address</label>
                                <input class="form-control" type="text" value="<?=$info['address']?>" name="address">
                            </div>
                    ...
                    <div class="card border-secondary mb-5">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <input type="hidden" name="selected_pro[<?=(int)$productSelectItem['pro_id']?>]" value="<?=$productSelectItem['quantity']?>">                             
